...
"[project]/src/app/TermsConditions/page.jsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const metadata = {
    ...
    openGraph: {
        title: `Terms & Conditions | ${process.env.SITE_NAME}`,
        description: `Learn about the usage terms, disclaimers, and service conditions for accessing IPO Grey Market data and IPO information on ${process.env.SITE_NAME}.`,
    ...
    twitter: {
        ...
        title: `Terms & Conditions | ${process.env.SITE_NAME}`,
        description: `Read the Terms & Conditions of ${process.env.SITE_NAME} covering user responsibilities, limitations, and service rules.`,
        images: [
            '/og-default.png'
        ]
    }
};
function TermsConditions({ title = "Terms And Conditions", lastUpdated = "Jun 4, 2025", content = null, contact = {
...
"[project]/src/app/TermsConditions/page.jsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/TermsConditions/page.jsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__6b8b641a._.js.map