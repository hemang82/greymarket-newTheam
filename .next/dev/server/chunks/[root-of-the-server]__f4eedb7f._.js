...
"[project]/src/app/sitemap.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function sitemap() {
    ...
    const staticPages = [
        ...
        {
            url: `${baseUrl}live-ipo`,
            lastModified: new Date()
        },
        {
            url: `${baseUrl}upcoming-ipo`,
            lastModified: new Date()
        },
        {
            url: `${baseUrl}news`,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$sitemap$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/sitemap.js [app-route] (ecmascript)");
...
if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$sitemap$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] !== 'function') {
    throw new Error('Default export is missing in "./sitemap.js"');
}
async function GET() {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$sitemap$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4eedb7f._.js.map