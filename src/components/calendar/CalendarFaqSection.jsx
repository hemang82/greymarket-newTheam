...
import { calendarFaqs } from "./calendarFaqData";

export default function CalendarFaqSection() {
  return (
    <section className="w-full my-16 space-y-6">
      <div className="text-center max-w-2xl mx-auto space-y-2">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#135c33] text-white">
          <HelpCircle className="size-3.5" />
          <span>Frequently Asked Questions</span>
        </div>
        <h2 className="text-2xl sm:text-3xl font-bold text-base-900 dark:text-base-100 font-display">
          IPO Calendar & Schedule FAQs
        </h2>
        <p className="text-xs sm:text-sm text-base-500 dark:text-base-400">
          Everything you need to know about tracking IPO dates, allotment, and listing schedules.
        </p>
      </div>
