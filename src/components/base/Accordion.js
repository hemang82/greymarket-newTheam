...
export function Accordion({ items = [] }) {
  return (
    <RAccordion.Root className="w-full rounded-md divide-y divide-base-200 dark:divide-base-800" type="single" collapsible >
      {items?.length > 0 &&
            ...
            <RAccordion.Header className="flex">
              ...
              >
                ...
                <Icon
                  ...
                  className={cn("ease-[cubic-bezier(0.87,_0,_0.13,_1)] transition-transform duration-300 group-data-[state=open]:rotate-180", "size-6")}
                  aria-hidden
                />
              </RAccordion.Trigger>
            </RAccordion.Header>
