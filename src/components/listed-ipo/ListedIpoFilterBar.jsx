...
import { Search, X, SlidersHorizontal, Building2, Rocket, TrendingUp, TrendingDown, Layers } from "lucide-react";
import { cn } from "@/lib/utils";

export default function ListedIpoFilterBar({
  searchQuery,
  setSearchQuery,
  activeCategory,
  setActiveCategory,
  sortBy,
  setSortBy,
  counts = { all: 0, main: 0, sme: 0, gainers: 0, losers: 0 },
}) {
  const categories = [
    { id: "all", label: "All Listed", icon: Layers, count: counts.all },
    { id: "main", label: "Mainboard", icon: Building2, count: counts.main },
    { id: "sme", label: "SME IPOs", icon: Rocket, count: counts.sme },
    { id: "gainers", label: "Premium Listings", icon: TrendingUp, count: counts.gainers },
    { id: "losers", label: "Discount Listings", icon: TrendingDown, count: counts.losers },
  ];
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        ...
        <div className="relative w-full sm:flex-1">
          ...
          <input
            ...
            placeholder="Search listed IPO by name or symbol (e.g. Annu Projects, Lenskart)..."
        ...
        <div className="w-full sm:w-auto flex items-center gap-2 self-end sm:self-auto">
          <div className="relative w-full sm:w-56">
            ...
            >
              <option value="listing_date_desc">Listing Date (Latest First)</option>
              <option value="gain_desc">Highest Listing Gain (%)</option>
              <option value="gain_asc">Lowest Listing Gain (%)</option>
              <option value="current_price_desc">Highest Current Price</option>
